...
variable "cluster_name" { type = string, default = "dr_statuspage_cluster" }
...
variable "db_allocated_storage" { type = number, default = 30 }
variable "db_instance_class" { type = string, default = "db.t3.medium" }
variable "ecr_repo_name" { type = string, default = "dr_repo_statuspage" }
